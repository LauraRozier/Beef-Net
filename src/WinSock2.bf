...
namespace Beef_Net
{
	...
	static
	{
		public const uint32 IOCPARM_MASK = 0x7FU;              // parameters must be < 128 bytes
		public const uint32 IOC_VOID     = 0x20000000U;        // no parameters
		public const uint32 IOC_OUT      = 0x40000000U;        // copy out parameters
		public const uint32 IOC_IN       = 0x80000000U;        // copy in parameters
